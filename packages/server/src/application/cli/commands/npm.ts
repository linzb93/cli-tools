import Has, { type Options as HasOptions } from '@/service/npm/has';
import Uninstall, { type Options as UninstallOptions } from '@/service/npm/uninstall';
import Search, { type Options as SearchOptions } from '@/service/npm/search';
interface IOption {
    help?: boolean;
    // 子模块的
    open?: boolean;
