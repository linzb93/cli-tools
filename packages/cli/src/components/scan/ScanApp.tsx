...
// import Table, { Header, Skeleton, CellProps } from '@/lib/Table';
...
//     // 自定义单元格组件（不使用bold，避免列宽计算误差）
//     const DataCell = (props: CellProps): React.ReactElement => <Text>{props.children}</Text>;
