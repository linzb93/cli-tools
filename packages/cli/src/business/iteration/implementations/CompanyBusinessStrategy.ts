 ...
 * 公司普通项目迭代策略
 */
export class CompanyBusinessStrategy extends BaseStrategy {
    readonly name = 'Company Business';
...
export const companyBusinessStrategy = new CompanyBusinessStrategy();
