...
// 获取基金信息与累计净值
exports.getFundInfo = ({ code, buyDate }) => service.post('/getFundInfo', {
    code,
    buyDate
});

// 获取基金今日分时涨幅
exports.getFundInfo = ({ FCODE }) => service({
 ...
 */
exports.getFundNetDiagram = ({ FCODE, RANGE }) => service({
...
// 获取往期基金经理列表
exports.getFundManagerList = ({ FCODE }) => service({
...
// 获取当前基金经理详情
exports.getFundMangerDetail = ({ FCODE }) => service({
...
// 获取基金持仓
exports.getFundMNInverstPosition = ({ FCODE }) => service({
...
// 获取基金排名
exports.getFundNMRankNewList = () => service({
